            ...
            if ($this->t_delay == -1) {
                if ($this->chest instanceof Chest) {
                    ...
                    if ($this->player instanceof Player) {
                        ...
                        $this->plugin->getServer()->broadcastMessage(TextFormat::AQUA . "$player " . C::YELLOW . "§ajust opened §bMysteryCrate §cand got: §3$slot13->getName() (x $slot13->getCount() from $this->plugin->crateName");
                    }
